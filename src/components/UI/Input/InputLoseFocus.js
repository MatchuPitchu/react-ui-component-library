...
import classes from './InputLoseFocus.module.css';
...
const InputLoseFocus = forwardRef(({ isValid, id, label, type, value, onChange, onBlur }, ref) => {
